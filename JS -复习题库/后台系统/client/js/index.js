...
$(function () {
    ...
    function change(index) {
        $navBox.eq(index).addClass('active').siblings().removeClass('active')
        if (index === 0) {
            $organize.css({
                display: 'block'
            })
            ...
            $ifrimeBox.attr('src','page/userlist.html')
        } else {
            $organize.css({
                display: 'none'
            })
            ...
            $ifrimeBox.attr('src','page/customerlist.html')
        }
    }
    change(initIndex);
